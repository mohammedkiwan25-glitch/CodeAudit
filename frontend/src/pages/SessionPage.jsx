...
import { BookOpenIcon, Code2Icon, Loader2Icon, LogOutIcon, PhoneOffIcon, VideoIcon } from "lucide-react";
...
const MOBILE_TABS = [
  { id: "problem", label: "Problem", icon: BookOpenIcon },
...
function SessionPage() {
  ...
  // Shared problem description JSX (used in both mobile and desktop)
        ...
        <div className="flex items-start justify-between mb-3 gap-3">
          <div>
            ...
            {problemData?.category && (
              <p className="text-base-content/60 mt-1 text-sm">{problemData.category}</p>
            )}
  ...
  return (
    <div className="h-screen bg-base-100 flex flex-col">
      ...
      {/* ── SINGLE LAYOUT (tabs for all screen sizes) ── */}
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-hidden">
          {mobileTab === "problem" && ProblemContent}
          ...
          {mobileTab === "code" && (
            <div className="h-full flex flex-col">
              ...
              <div className="h-40 shrink-0 border-t border-base-300">
